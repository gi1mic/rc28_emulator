...
-    3 x momentary push-to-make buttons to act as TX, F1 and F2 (From £6 each - search Amazon for HALJIA 16mm Red Ring Led Metal Momentary Push Button. Inc's LEDs) Note, these buttons are fine for the functions but require to much travel to make a good TX switch)
